...
py.savefig('Cubic 2D figures/x vs y plot.jpg',dpi=500)
...
py.savefig("Cubic 2D figures/Cubic2D-u vs time.jpg",dpi=500)
...
py.savefig('Cubic 2D figures/residual-plot.jpg',dpi=500)
 
print(Xi)
np.savetxt('Cubic 2D figures/SIND equation.txt',Xi,fmt="%4.4f")